...
from flcore.servers.serversa import FedSA
...
def run(args):
    ...
    for i in range(args.prev, args.times):
        ...
        # add FedAvg, Resnet18, HtFE5
        if args.model_family == "FedAvg":
            args.models = [
...
if __name__ == "__main__":
    ...
    # FedSa -lam 10 -mcl 1.0 -cc 1.0
    # parser.add_argument('-lam', "--lamda", type=float, default=10.0)
    ...
    # FedPCL
    parser.add_argument('-tau', "--tau", type=float, default=0.07)
